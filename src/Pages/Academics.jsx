...
const Academics = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-gray-50 pb-16 font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center divide-x divide-gray-100">
                <div className="flex flex-col items-center">
                    ...
                    <span className="font-bold text-gray-800 text-lg">20+ Courses</span>
                    <span className="text-xs text-gray-500 uppercase">Across 3 Streams</span>
                </div>
                <div className="flex flex-col items-center">
                    <Users className="h-8 w-8 text-blue-600 mb-2" />
                    <span className="font-bold text-gray-800 text-lg">15:1 Ratio</span>
                    <span className="text-xs text-gray-500 uppercase">Student to Faculty</span>
                </div>
                <div className="flex flex-col items-center">
                    <Monitor className="h-8 w-8 text-blue-600 mb-2" />
                    <span className="font-bold text-gray-800 text-lg">Smart Labs</span>
                    <span className="text-xs text-gray-500 uppercase">Digital Learning</span>
                </div>
                <div className="flex flex-col items-center">
                    <Library className="h-8 w-8 text-blue-600 mb-2" />
                    <span className="font-bold text-gray-800 text-lg">50k+ Books</span>
                    <span className="text-xs text-gray-500 uppercase">Central Library</span>
                </div>
            </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-2">Choose your path to success</p>
        </div>

        <div className="flex justify-center mb-12">
          <div className="inline-flex bg-white p-1.5 rounded-full shadow-md border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-20">
          {coursesData[activeTab].map((course, index) => (
            <div key={index} className="group bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300 relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1 h-full bg-blue-600 group-hover:w-2 transition-all"></div>
              
              <div className="flex justify-between items-start mb-4 pl-4">
                <h3 className="text-2xl font-bold text-gray-900 group-hover:text-blue-700 transition-colors">{course.title}</h3>
                <span className="bg-blue-50 text-blue-700 border border-blue-100 text-xs font-bold px-3 py-1 rounded-full">
                  {course.code}
                </span>
              </div>
              
              <p className="text-gray-600 mb-6 pl-4 leading-relaxed">{course.desc}</p>
              
              <div className="grid grid-cols-2 gap-4 text-sm text-gray-500 mb-8 pl-4">
              ...
              <div className="flex gap-4 pl-4">
                <button className="flex-1 bg-white border border-gray-300 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-50 transition">
                  View Syllabus
                </button>
        ...
        {/* 5. WHY CHOOSE US (New Feature) */}
        <div className="bg-blue-50 rounded-3xl p-8 md:p-12 mb-20">
            <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 className="text-3xl font-bold text-blue-900 mb-6">Why Study at Anugrah Memorial?</h2>
                    <ul className="space-y-4">
                        <li className="flex items-start">
                            <div className="bg-blue-200 p-1 rounded-full mr-3 mt-1"><Award className="w-4 h-4 text-blue-800"/></div>
                            <div>
                                <h4 className="font-bold text-gray-800">Holistic Development</h4>
                                <p className="text-sm text-gray-600">We focus on character building alongside academic grades.</p>
                            </div>
                        </li>
                        <li className="flex items-start">
                            <div className="bg-blue-200 p-1 rounded-full mr-3 mt-1"><Monitor className="w-4 h-4 text-blue-800"/></div>
                            <div>
                                <h4 className="font-bold text-gray-800">Digital Classrooms</h4>
                                <p className="text-sm text-gray-600">Modern projection systems and e-learning resources.</p>
                            </div>
                        </li>
                        <li className="flex items-start">
                            <div className="bg-blue-200 p-1 rounded-full mr-3 mt-1"><Users className="w-4 h-4 text-blue-800"/></div>
                            <div>
                                <h4 className="font-bold text-gray-800">Seminars & Workshops</h4>
                                <p className="text-sm text-gray-600">Regular industry interaction and guest lectures.</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div className="bg-white p-8 md:p-10 rounded-2xl shadow-lg border border-gray-100">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                <BookOpen className="mr-3 text-blue-600" /> Student Resources
            </h2>
            <Link to="/contact" className="text-blue-600 font-semibold text-sm hover:underline mt-2 md:mt-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
                ...
                <div key={i} className="flex items-center justify-between p-5 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-blue-200 cursor-pointer group transition-all">
                    <div className="flex items-center">
                        <FileText className={`h-10 w-10 ${item.color} bg-gray-50 p-2 rounded-lg mr-4`} />
                        <div>
                        <h4 className="font-bold text-gray-800 group-hover:text-blue-700 transition">{item.title}</h4>
                        <p className="text-xs text-gray-500">{item.sub}</p>
                        </div>
                    </div>
                    <div className="bg-gray-100 p-2 rounded-full group-hover:bg-blue-600 group-hover:text-white transition">
