...
import { 
  ...
  ArrowRight, Video, Bell, Star, ChevronRight 
} from 'lucide-react';
  ...
  return (
    <div className="font-sans text-gray-800 dark:text-gray-200 transition-colors duration-300">
      ...
      <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-0 w-full bg-gradient-to-t from-gray-50 dark:from-slate-900 to-transparent pt-20"></div>
      </div>

      {/* 2. NOTICE BOARD */}
      <div className="bg-blue-900 dark:bg-blue-950 text-white overflow-hidden flex items-center h-12 border-b border-blue-800 dark:border-blue-900">
        <div className="bg-blue-800 dark:bg-blue-900 px-6 h-full flex items-center font-bold text-sm uppercase tracking-wider z-10 shadow-md">
      ...
      <div className="py-20 bg-gray-50 dark:bg-slate-900 relative -mt-10 z-20 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-slate-700 text-center hover:transform hover:-translate-y-2 transition-all duration-300 group">
                <div className="w-16 h-16 bg-blue-50 dark:bg-slate-700 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-blue-600 transition-colors duration-300">
                ...
                <p className="text-gray-500 dark:text-gray-400 font-medium text-sm uppercase tracking-wide">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="py-20 bg-white dark:bg-slate-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-blue-100 dark:bg-blue-900/30 rounded-full z-0"></div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-yellow-100 dark:bg-yellow-900/20 rounded-full z-0"></div>
              <img 
              ...
              />
              <div className="absolute bottom-8 right-8 z-20 bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg max-w-xs border border-gray-100 dark:border-slate-700">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Consistently ranked among the best constituent colleges in Magadh University.</p>
              </div>
            </div>
            
            <div>
              <h4 className="text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider mb-2">Why Anugrah Memorial</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden border border-gray-100 dark:border-slate-700 hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {course.tags.map((tag, t) => (
                      <span key={t} className="px-3 py-1 bg-blue-50 dark:bg-slate-700 text-blue-700 dark:text-blue-300 text-xs font-semibold rounded-full">
                        {tag}
                      </span>
                    ))}
                  </div>

                  <Link to="/academics" className="inline-flex items-center text-blue-600 dark:text-blue-400 font-bold hover:text-blue-800 dark:hover:text-blue-300 transition-colors group/link">
      ...
      {/* 6. CTA / ADMISSIONS */}
      <div className="relative py-24 bg-blue-900 dark:bg-blue-950 overflow-hidden">
        {/* Decorative Background Elements */}
        <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-blue-800 dark:bg-blue-900 rounded-full opacity-50 blur-3xl"></div>
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-cyan-800 dark:bg-cyan-900 rounded-full opacity-50 blur-3xl"></div>
